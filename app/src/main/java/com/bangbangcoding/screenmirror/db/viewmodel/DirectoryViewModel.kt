...
import com.bangbangcoding.screenmirror.db.model.CachingDocumentFile
import com.bangbangcoding.screenmirror.db.model.toCachingList
...
class DirectoryViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _openDirectory = MutableLiveData<CachingDocumentFile>()
    val openDirectory = _openDirectory

    private val _openDocument = MutableLiveData<CachingDocumentFile>()
