...
import com.bangbangcoding.screenmirror.web.ui.studio.multidownload.DownloadConfiguration;
...
import com.bangbangcoding.screenmirror.web.ui.studio.multidownload.DownloadRequest;
import com.bangbangcoding.screenmirror.web.ui.studio.multidownload.architecture.ConnectTask;
import com.bangbangcoding.screenmirror.web.ui.studio.multidownload.architecture.DownloadResponse;
import com.bangbangcoding.screenmirror.web.ui.studio.multidownload.architecture.DownloadStatus;
    ...
    private List<ThreadInfo> getMultiThreadInfos(long length) {
        ...
        if (threadInfos.isEmpty()) {
            ...
            for (int i = 0; i < threadNum; i++) {
                ...
                Log.e("downttt", "getMultiThreadInfos: " + mTag);
