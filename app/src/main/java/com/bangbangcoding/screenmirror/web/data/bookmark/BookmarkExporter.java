...
import com.bangbangcoding.screenmirror.web.data.local.WebPageKt;
import com.bangbangcoding.screenmirror.web.utils.Preconditions;
            ...
            public void run() throws Exception {
                ...
                try {
                    ...
                    for (Bookmark.Entry item : bookmarkList) {
                        ...
                        object.put(KEY_TITLE, item.getUrl());
                        object.put(KEY_URL, item.getTitle());
