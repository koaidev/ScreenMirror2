package com.bangbangcoding.screenmirror.web.utils;//package com.highsecure.videodownloader.utils;
//
...
//import com.highsecure.videodownloader.ui.preference.DeveloperPreferences;
...
//                            }
//                        })
//                    .setPositiveButton(activity.getResources().getString(R.string.txt_ok),
//                        new DialogInterface.OnClickListener() {
//                            @Override
//                            public void onClick(DialogInterface dialog, int which) {
...
//
//        try {
//            WebkitProxy.setProxy(KunApplication.class.getName(), activity.getApplicationContext(), null, host, port);
//        } catch (Exception e) {
...
//                snackbar(activity, R.string.i2p_not_running);
//                return false;
//            } else if (!mI2PHelper.areTunnelsActive()) {
//                snackbar(activity, R.string.i2p_tunnels_not_ready);
//                return false;
//            }
//        }
//
...
//        } else {
//            try {
//                WebkitProxy.resetProxy(KunApplication.class.getName(), activity.getApplicationContext());
//            } catch (Exception e) {
...
//                    snackbar(activity, R.string.install_orbot);
//                }
//                break;
//            case Constants.PROXY_I2P:
