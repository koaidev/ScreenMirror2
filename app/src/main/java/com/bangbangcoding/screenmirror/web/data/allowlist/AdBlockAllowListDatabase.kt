...
import com.bangbangcoding.screenmirror.web.data.local.databaseDelegate
import com.bangbangcoding.screenmirror.web.utils.ext.firstOrNullMap
import com.bangbangcoding.screenmirror.web.utils.ext.useMap
...
class AdBlockAllowListDatabase @Inject constructor(
    ...
    override fun addAllowListItem(whitelistItem: AllowListItem): Completable =
    ...
    override fun removeAllowListItem(whitelistItem: AllowListItem): Completable =
        Completable.fromAction {
