                            ...
                            if (readLine == null) {
                                ...
                                if (hashMap != null) {
                                    ...
                                    if (readLine.contains("PROGRESSIVE-URI")) {
                                        ...
                                        Log.e("ttt", "daily: doInBackground: s3 " + split3[3]);
            ...
            try {
                ...
                if (removeDuplicates != null && removeDuplicates.size() > 0) {
                    ...
                    for (int i = 0; i < removeDuplicatesvalues.size(); i++) {
                        ...
                        videoInfo.setUrl(removeDuplicatesvalues.get(i).getUrl());
                        videoInfo.setTitle("Dailymotion_" + System.currentTimeMillis());
                        videoInfo.setFormat(removeDuplicatesvalues.get(i).getQuality());
