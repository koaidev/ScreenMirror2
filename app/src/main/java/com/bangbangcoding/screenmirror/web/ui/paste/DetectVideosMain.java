...
public class DetectVideosMain {
    ...
    public static DownloadVideosMain.OnDetectListener mListener;
    public static SharedPreferences prefs;
    public static Boolean fromService;
    public static String videoUrl;
    static String mTitle;
    public static String mPrefixTitle = "";
    static String myURLIS = "";
    private static String newurl;
    public static boolean IssupportUrl = false;

    public static void startDetect(final Context context, String url, Boolean service, DownloadVideosMain.OnDetectListener listener) {
        try {
            mPrefixTitle = "";
            mContext = context;
            fromService = service;
...
//                FbVideoDownloader fbVideoDownloader = new FbVideoDownloader(mContext, url, 1);
                fbVideoDownloader.setListener(mListener);
                fbVideoDownloader.downloadVideo();
            } else if (url.contains("popcornflix")) {
                url = url.substring(url.lastIndexOf("/") + 1);
                Log.e("ttt", "popcornflix url = " + url);
...
//                                    DownloadFileMain.startDownloading(context, matag, "Popcornflex_" + System.currentTimeMillis(), ".mp4");
                        ...
                        .getAsJSONObject(new JSONObjectRequestListener() {
                            ...
                            public void onResponse(JSONObject response) {
                                ...
                                try {
                                    ...
                                    VideoInfo videoInfo = new VideoInfo();
                                    videoInfo.setTitle("Veoh_" + System.currentTimeMillis());
                                    videoInfo.setUrl(matag);
                                    videoInfo.setExt(".mp4");
                                    ArrayList<VideoInfo> videos = new ArrayList<VideoInfo>();
                                    videos.add(videoInfo);
                ...
                try {
                    ...
                    if (url.contains("?referrer=share")) {
                        ...
                        Log.e("ttt", "moj 000=" + url + " size " + url.indexOf("?"));
                        Log.e("ttt", "moj 000=" + "https://moj-apis.sharechat.com/videoFeed?postId=" + url + "&firstFetch=true");
                    }
                            ...
                            .getAsJSONObject(new JSONObjectRequestListener() {
                                ...
                                public void onResponse(JSONObject response) {
                                    ...
                                    try {
                                        ...
                                        Log.e("ttt", "moj " + matag);
                                        VideoInfo videoInfo = new VideoInfo();
                                        videoInfo.setTitle("Moj_" + System.currentTimeMillis());
                                        videoInfo.setUrl(matag);
                                        videoInfo.setExt(".mp4");
                                        ArrayList<VideoInfo> videos = new ArrayList<VideoInfo>();
                                        videos.add(videoInfo);
...
//            https://likee.video/@Aish4/video/6989882553836555260?postId=6989882553836555260
                ...
                Log.i("ttt", "sharechat url = " + url);
                try {
                    url = Utils.extractUrls(url).get(0);
                    int index = url.lastIndexOf('/') + 1;
                    url = url.substring(index);
                    Log.e("ttt", "sharechat new url =  " + url);
                            ...
                            .getAsJSONObject(new JSONObjectRequestListener() {
                                ...
                                public void onResponse(JSONObject response) {
                                    ...
                                    try {
                                        ...
                                        Log.e("ttt", "wojfdjhfdjh " + matag);
                                        listener.onDataResult(true, true, null);
                                        mListener.onDataResult(true, true, null);
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                mListener.onDataResult(false, true, null);
                            }
                        }
                    }).start();
                } else {
...
//                new CallDriveData().execute(url);
                ...
                downloader.downloadVideo();
                    ...
                    && !url.equals("https://www.buzzvideo.com/feed/foryou")
                    && !url.equals("https://www.buzzvideo.com")) {
                Log.e("ttt", "buzzvideo");
                BuzzVideoDownloader downloader = new BuzzVideoDownloader(mContext, url);
                downloader.setListener(listener);
                downloader.DownloadVideo();
            } else if (url.contains("vimeo.com") && !url.endsWith("vimeo.com/watch")
                    && !url.endsWith("vimeo.com/watch/")) {
                CalldlApisDataData(url, true);
...
//Todo revert later
    ...
    /**
     * "https://social.triller.co/v1.5/api/videos/" + url1.substring(url1.indexOf("/video/") + 7);
     */
            ...
            AndroidNetworking.get("https://api.chingari.io/post/post_details/" + urlstr[1])
                    ...
                    .getAsJSONObject(new JSONObjectRequestListener() {
                        ...
                        public void onResponse(JSONObject response) {
                            String matag = "";
                            try {
                                Log.e("ttt", "CallchingariData " + response);
                                JSONObject jsonObject = new JSONObject(response.toString());
...
//        openConnection.setRequestProperty("ModelUserInstagram-Agent", "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.11 (KHTML, like Gecko) Chrome/23.0.1271.95 Safari/537.11");
                    ...
                    .getAsJSONObject(new JSONObjectRequestListener() {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            try {
                                ...
                                if (hasQualityOption) {
                                    mListener.onDataResult(true, false, null);
                                } else {
                                    mListener.onDataResult(true, true, null);
                                ...
                                Log.e("ttt", "catch: CallVKData url" + url + "//" + str2.getMessage());
                            }
                        }

                        @Override
                        public void onError(ANError error) {
                            Log.e("ttt", "onError: CallVKData url" + url + "//" + error.getMessage());
                        }
                    });
        } else {
                    ...
                    .getAsJSONObject(new JSONObjectRequestListener() {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            try {
                                ...
                                Log.e("ttt", "catch: CallVKData url" + url + "//" + e.getMessage());
                            }
                        }

                        @Override
                        public void onError(ANError error) {
                            Log.e("ttt", "CallVKData url : " + url + "error:  " + error.getErrorBody());
                        }
                    });
        }
    }
    ...
    public static void CalldlApisDataData(String url, boolean hasQualityOption) {
        Log.e("ttt", "CallDLApisDataData url = " + url);
        AndroidNetworking.get(Constants.DlApisUrl3 + url + "&flatten=True")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    @Override
                    public void onResponse(JSONObject response) {
                        Log.e("ttt", "CallDLApisDataData: reps = " + response);
                        parseCalldlApisDataData(response);
                    }
                    @Override
                    public void onError(ANError error) {
                        mListener.onDataResult(false, true, null);
                        Log.e("ttt", "url " + url + " ; error =" + error.getErrorBody());
                    }
                });
    }
                ...
                if (gsonObj.getVideos().size() > 1) {
                    ...
                    if (gsonObj.getVideos().get(0).getProtocol() != null) {
                        ...
                        for (Video format : videoListSub) {
                            ...
                            String ext = DownloadUtils.addCharacterExt(format.getExt());
                            videoInfo.setExt(ext);
                        ...
                        mListener.onDataResult(true, false, videos);
                    }
                } else {
    ...
    public static class GetInstagramVideo extends AsyncTask<String, Void, Document> {
        ...
        protected Document doInBackground(String... urls) {
            Log.e("ttt", "Instagram doInBackground " + urls[0]);
            Log.e("ttt", "FB cookie " + CookieManager.getInstance().getCookie(urls[0]));
            try {
                doc = Jsoup.connect(urls[0])
                        .header("cookie", CookieManager.getInstance().getCookie(urls[0]))
                        .get();
            } catch (Exception e) {
                e.printStackTrace();
        ...
        protected void onPostExecute(Document result) {
            try {
                ...
                mTitle = result.title();
                Log.e("ttt", "Instagram onPostExecute " + mTitle);
                VideoInfo videoInfo = new VideoInfo();
                videoInfo.setTitle(mTitle);
                ...
                Log.e("ttt", "Instagram onPostExecute " + e.getMessage());
                e.printStackTrace();
            }
        }
    }
    ...
    public static class CallJoshData extends AsyncTask<String, Void, Document> {
        ...
        public void onPostExecute(Document document) {
            try {
                ...
                if (!html.equals("")) {
                    ...
                    if (!this.videoUrl.equals("")) {
                        try {
                            ...
                            Log.e("ttt", "CallJoshData exp1 " + document2.getMessage());
                            mListener.onDataResult(false, true, null);
                            document2.printStackTrace();
                        }
                    }
                ...
                mListener.onDataResult(false, true, null);
                Log.e("ttt", "CallJoshData exp " + unused.getMessage());
            }
        }
    }
    ...
    public static class CalltumblerData extends AsyncTask<String, Void, Document> {
        ...
        public void onPostExecute(Document document) {
            try {
                // Log.e("ttt","myresponseis111 exp166 " + document);
//                Log.e("ttt","myresponseis111 exp166 " + document.select("source[src]").first().attr("src"));
//                Log.e("ttt","myresponseis111 exp177 " + document.select("video[src]").first().attr("src"));
    ...
    public static class CallRedditData extends AsyncTask<String, Void, Document> {
        ...
        public void onPostExecute(Document document) {
            try {
                ...
                //Log.e("ttt","myresponseis111 exp166 " + document.select("a[class=\"downloadbutton \"]").last().attr("src"));
//                Log.e("ttt","myresponseis111 exp177 " + document.select("video[src]").first().attr("src"));
