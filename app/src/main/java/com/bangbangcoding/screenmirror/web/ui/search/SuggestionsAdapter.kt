...
import com.bangbangcoding.screenmirror.web.data.local.WebPage
...
class SuggestionsAdapter(
    ...
    init {
        ...
        darkTheme = PrefUtils.getBoolean(context, Constants.THEME) || isIncognito
        ...
        searchDrawable = ThemeUtils.getThemedDrawable(
            context,
            R.drawable.ic_search_22,
            PrefUtils.getBoolean(context, Constants.THEME)
        )
        bookmarkDrawable = ThemeUtils.getThemedDrawable(
            context,
            R.drawable.ic_bookmark,
            PrefUtils.getBoolean(context, Constants.THEME)
        )
        historyDrawable = ThemeUtils.getThemedDrawable(
            context,
...
//        holder.imageView.setColorFilter(Utils.getColorDrawableTab(context))
//        holder.titleView.setTextColor(Utils.getColorDrawableTab(context))
//        holder.urlView.setTextColor(Utils.getUrlColor(context))
//        holder.bgView.setBackgroundColor(Utils.getBackgroundColorSuggestion(context))
