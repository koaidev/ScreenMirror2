...
public class ThreadInfoDao extends AbstractDao<ThreadInfo> {
    ...
    private static final String TABLE_NAME = "MyThreadInfoDao";
    ...
    public static void createTable(SQLiteDatabase db) {
        db.execSQL("create table " + TABLE_NAME + "(_id integer primary key autoincrement, id integer, tag text, uri text, name text,start long, _end long, finished long)");
    }
    ...
    public void insert(ThreadInfo info) {
        ...
        db.execSQL("insert into "
                        + TABLE_NAME
                        + "(id, tag, uri, name, start, _end, finished) values(?, ?, ?, ?, ?, ?, ?)",
                new Object[]{info.getId(), info.getTag(), info.getUri(), info.getName(), info.getStart(), info.getEnd(), info.getFinished()});
    }
    ...
    public List<ThreadInfo> getThreadInfos(String tag) {
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                info.setEnd(cursor.getLong(cursor.getColumnIndex("_end")));
